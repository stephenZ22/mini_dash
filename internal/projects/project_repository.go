...
func (r *ProjectRepository) Update(id uint, project *Project) error {
	...
	if err := r.db.Model(&Project{}).Where("id = ?", id).Updates(project).Error; err != nil {
		return err
	}
...
func (r *ProjectRepository) List(page_size, page_num int) ([]Project, error) {
